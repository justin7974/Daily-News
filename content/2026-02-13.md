...
**1. 史诗级突破：用 GLM-5 完整复刻 GBA 模拟器** (赛博禅心)
https://mp.weixin.qq.com/s/yNpY0t4ZzD_ewUySDp5AdA
...
**2. 速递｜Founders Fund 等领投 Anthropic 200 亿融资** (Z Potentials)
...
**3. 年末 AI 回顾：从模型到应用，从技术到商战** (晚点LatePost)
https://mp.weixin.qq.com/s/gyEbK_UaUO3AeQvuhhRZ6g
...
**4. 深度｜AI教母李飞飞最新访谈：AI 下一前沿是空间智能** (Z Potentials)
https://mp.weixin.qq.com/s/3DcdCHk5_70NozkguuQSQw
...
**5. OpenAI 智能体工程指南：10 条实战技巧** (宝玉AI)
https://mp.weixin.qq.com/s/pFOrsaSuONInS_uQA9tV9g
OpenAI 发布 Agent 工程实战指南，涵盖 3 种构建模式和 10 条核心技巧。

**6. 我们真的变成巫师了：OpenAI API 负责人谈 AI 重塑软件工程** (宝玉AI)
https://mp.weixin.qq.com/s/CTq03t9_F3lkMwLS4Qu_7Q
OpenAI API 负责人分享 AI 编程的未来愿景，认为开发者角色正在从"写代码"转向"指挥AI"。

**7. 晚点独家丨荣耀前 CEO 赵明将出任千里科技联席董事长** (晚点LatePost)
https://mp.weixin.qq.com/s/SgXAUq2n_tEU2uf4P47ivA
荣耀前CEO赵明加入千里科技，手机高管转型机器人赛道。

**8. 终于在国产AI上看到了Opus的影子｜GLM-5深度实测** (AI产品黄叔)
https://mp.weixin.qq.com/s/myld2eskKki5Q6MMvFeBvw
对 GLM-5 进行多场景实测，编程和推理能力接近 Claude Opus。

**9. 我用 GLM-5 写了一个完整的工具，聊聊长程 Vibe Coding** (洛小山)
https://mp.weixin.qq.com/s/7N1Jv6B7nUY246z6PweeAw
使用 GLM-5 完成完整项目开发的实战记录，探讨长程 AI 编程的方法论。

**10. 豆包上可以体验 Seedance 2.0 了** (宝玉AI)
https://mp.weixin.qq.com/s/DJ3vkOLJ62vczooxPweSNg
字节旗下豆包平台上线 Seedance 2.0 视频生成功能，用户可直接体验。

**11. GLM-5深夜登场，国产开源模型首次逼平Claude Opus 4.5** (数字生命卡兹克)
https://mp.weixin.qq.com/s/3EI0mLmJ5RAnoY67rrrKzQ
GLM-5 发布即开源，多项测试成绩接近 Claude Opus 4.5 水平。

**12. xAI 全员大会实录** (宝玉AI)
https://mp.weixin.qq.com/s/Wy-fhA-94W5szSY_j8RuHw
